 ...
 * differencer. This class is not intended to be instantiated or subclassed outside of the Compare framework.
 * <p>
...
public class RangeDifference
{
   ...
   */
  /* package */ RangeDifference(int kind,
      int rightStart,
      int rightLength,
      int leftStart,
      int leftLength)
  ...
  {
    return Math.max(fRightLength,
                    Math.max(fLeftLength,
                             lAncestorLength));
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj instanceof RangeDifference)
    {
      ...
      return fKind == other.fKind && fLeftStart == other.fLeftStart && fLeftLength == other.fLeftLength
          && fRightStart == other.fRightStart && fRightLength == other.fRightLength
          && lAncestorStart == other.lAncestorStart && lAncestorLength == other.lAncestorLength;
    }
  ...
  {
    String string = "Left: " + toRangeString(fLeftStart, //$NON-NLS-1$
                                             fLeftLength)
        + " Right: " + toRangeString(fRightStart, //$NON-NLS-1$
                                     fRightLength);
    if (lAncestorLength > 0 || lAncestorStart > 0)
      string += " Ancestor: " + toRangeString(lAncestorStart, //$NON-NLS-1$
                                              lAncestorLength);
    return string;
  }
