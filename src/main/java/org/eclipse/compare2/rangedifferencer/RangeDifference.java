 ...
 * <code>RangeDifferencer</code> <code>find* </code> methods. Clients use these objects as they are returned from the
 * differencer. This class is not intended to be instantiated outside of the Compare framework.
 * <p>
 * Note: A range in the <code>RangeDifference</code> object is given as a start index and length in terms of comparable
 * entities. However, these entity indices and counts are not necessarily character positions. For example, if an entity
...
public class RangeDifference
{
  ...
  /**
   * Creates a new <code>RangeDifference</code> with the given change kind and left and right ranges.
   *
   * @param kind
   *          the kind of change
   * @param rightStart
  ...
  /**
   * Creates a new <code>RangeDifference</code> with the given change kind and left, right, and ancestor ranges.
   *
   * @param kind
   *          the kind of change
   * @param rightStart
   ...
   *
   * @return the kind of difference, one of <code>NOCHANGE</code>, <code>CHANGE</code>, <code>LEFT</code>,
   *         <code>RIGHT</code>, <code>ANCESTOR</code>, <code>CONFLICT</code>, <code>ERROR</code>
   */
  public int kind()
  {
    return this.kind;
  ...
  {
    return Math.max(this.rightLength,
                    Math.max(this.leftLength,
                             this.ancestorLength));
  }
  ...
  public boolean equals(Object obj)
  {
    if (obj instanceof RangeDifference)
    {
      ...
      return this.kind == other.kind && this.leftStart == other.leftStart && this.leftLength == other.leftLength
          && this.rightStart == other.rightStart && this.rightLength == other.rightLength
          && this.ancestorStart == other.ancestorStart && this.ancestorLength == other.ancestorLength;
    }
  ...
  public String toString()
  {
    ...
    buf.append("Left: " + toRangeString(this.leftStart, //$NON-NLS-1$
                                        this.leftLength)
        + " Right: " + toRangeString(this.rightStart, //$NON-NLS-1$
                                     this.rightLength));
    if (this.ancestorLength > 0 || this.ancestorStart > 0)
      buf.append(" Ancestor: " + toRangeString(this.ancestorStart, //$NON-NLS-1$
                                               this.ancestorLength));
  ...
  private String toRangeString(int start,
      int length)
  {
