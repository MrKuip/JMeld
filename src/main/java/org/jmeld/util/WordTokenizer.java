...
public class WordTokenizer
{
  ...
  /**
   * Get the tokens of the text. All tokens and non-tokens are returned in the result. So that the length of the text is
   * the same length as the length of all tokens.
   */
