...
public class JComboBoxSelectionPreference
    extends Preference
{
  // Class variables:
  ...
  public JComboBoxSelectionPreference(String preferenceName,
      JComboBox target)
  {
  ...
  private void init()
  {
    ...
    selectedItem = getString(SELECTED_ITEM,
                             null);
