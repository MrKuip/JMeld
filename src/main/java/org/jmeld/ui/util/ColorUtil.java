...
public class ColorUtil
{
  ...
  /**
   * Get the brightness of a color. The H from HSB!
   */
      ...
      float saturation)
  {
    ...
    color = new Color(Color.HSBtoRGB(hsbvals[0],
                                     hsbvals[1],
                                     hsbvals[2]));
      ...
      float brightness)
  {
    ...
    hsbvals[2] = Math.min(hsbvals[2],
                          1.0f);
    hsbvals[2] = Math.max(hsbvals[2],
                          0.0f);
