 ...
 *
 */
package org.apache.jmeld2.tools.ant.types.selectors;
...
public final class SelectorUtils
{
   ...
   * likewise returns true. Otherwise, target is newer than src and is not out of
   * date, thus the method returns false. It also returns false if the src file
   * doesn't even exist, since how could the target then be out of date.
   *
   ...
   * of tokens as documented in the single arguement constructor.
   *
