...
import org.apache.jmeld.tools.ant.types.resources.selectors.ResourceSelector;
    ...
    extends ResourceSelector
{
   ...
   * If there is a problem with the setup of a selector, it can throw a
   * BuildException to indicate the problem.
   *
