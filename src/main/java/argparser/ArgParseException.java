...
/**
 * Exception class used by <code>ArgParser</code> when command line arguments contain an error.
 * 
    ...
    extends IOException
{
   ...
   *          Error message
   */
  public ArgParseException(String arg,
      String msg)
  {
    super(arg + ": " + msg);
  }

  private static final long serialVersionUID = 1097848951344055555L;
}
